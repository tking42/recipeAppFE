...
const Form = () => {
    ...
    return (
        <>
            <div className={`max-w-lg mx-auto my-8 p-6 bg-white rounded-lg shadow-lg text-gray-700 ${hide}`}>
            ...
            <RecipeResults ing1={ingredient1} ing2={ingredient2} ing3={ingredient3} ing4={ingredient4} ing5={ingredient5}
                           recipesReturned={recipesReturned} setHidden={setHidden} setHide={setHide} hidden={hidden}/>
        </>
    );
};
